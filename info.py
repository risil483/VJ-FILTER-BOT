...
API_ID = int(environ.get('API_ID', '29199736'))
API_HASH = environ.get('API_HASH', '6fb34b3b98f2f89ee82fbf87fa932e83')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1824756035 6037449334').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002501558361'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001637410194').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002359897478') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4621701913')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002529751069').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rss043133:risilshihab000@cluster0.8i3odye.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "malayalammovieuniverse")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+E6EGPMcY9VYxNGM9)
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+W-rVR-knXdY1NzBl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+HgXjEAR1-CY4Y2M1) # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Let_owner')
